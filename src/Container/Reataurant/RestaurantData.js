...
export const restaurantData = [
    {
      Restaurant_img: eatly,
      Restaurant_name: "Hexagon",
      Restaurant_description: "Hexagon is a trendy restaurant located in the heart of the city. They specialize in contemporary fusion cuisine, blending flavors from all over the world to create unique and delicious dishes. Their menu includes a range of appetizers, entrees, and desserts, all made with the freshest ingredients and expertly prepared by their talented chefs. With a chic and stylish ambiance, Hexagon is the perfect spot for a romantic dinner or a night out with friends."
    },
    {
